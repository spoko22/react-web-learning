...
export default () => (
    <Box full="horizontal">
        <Accordion size="small" active={0}>
            ...
            <AccordionPanel heading='Badanie otoczenia społecznego'>
                <Paragraph>
            ...
            <AccordionPanel heading='Badanie otoczenia politycznego'>
                <Paragraph>
            ...
            <AccordionPanel heading='Badanie otoczenia prawnego'>
                <Paragraph>
            ...
            <AccordionPanel heading='Badanie stanu wiedzy'>
                <Paragraph>
